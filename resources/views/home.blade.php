...
@section('content')
    <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
        ...
        <p class="text-sm text-gray-400 mt-2">Proyecto de desarollo web para profesionales</p>
        <img
            src="https://res.cloudinary.com/practicaldev/image/fetch/s--gE188HlF--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.imgur.com/ofsdFSQ.png"
            alt="dev" class="absolute -right-20 -bottom-20 opacity-20">
    </div>
